...
use app\models\CrackerSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CrackerController implements the CRUD actions for Cracker model.
 */
class CrackerController extends Controller
{
    ...
    {
        if (($model = Cracker::findOne($id)) !== null) {
            return $model;
        } else {
